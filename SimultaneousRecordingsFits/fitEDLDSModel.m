%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% EDLDS fits for simultaneous recording data
% 
% Results will be stored in folder TempDatDir
% 
% err_model1 -- constant A, C
% err_model2 -- constant A
% err_model3 -- constant C
% err_model4 -- variable A, C
%
% ==========================================
% Ziqiang Wei
...
for nSession = 15:numSession
    ...
    save([TempDatDir 'Session_' num2str(nSession) '.mat'],'err_model1','err_model2', 'err_model3', 'err_model4');
