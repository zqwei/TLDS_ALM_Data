...
box off
set(gca, 'TickDir', 'out')
setPrint(8*2, 6, 'Plots/ReactionTimeVar_FullScore')
...
xlim([-0.5 0.5])
ylim([-0.5 0.5])
xlabel('Ipsi rank correlation RT-LDA')
ylabel('Contra rank correlation RT-LDA')
box off
set(gca, 'TickDir', 'out')
setPrint(8, 6, 'Plots/ContraIpsi_FullScore')
