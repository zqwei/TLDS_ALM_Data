...
for nSession = 1:numSession
    ...
    [p, h]        = corr(scoreMat(totTargets & firstLickTime<timeMax), firstLickTime(totTargets & firstLickTime<timeMax), 'type', 'Spearman');
...
xlabel('neural space')
ylabel('TLDS')
set(gca, 'TickDir', 'out','xTick', [0 0.5], 'yTick', [0 0.5])
