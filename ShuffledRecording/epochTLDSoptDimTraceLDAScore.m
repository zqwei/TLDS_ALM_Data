...
for nSession = 1:numSession
    ...
    scoreMat      = nan(numTrials*nFold, size(nSessionData, 3));
    ...
    setPrint(8*2, 6*2, ['Plots/TLDSLDASimilarityExampleSesssionShf_idx_' num2str(nSession, '%02d') '_xDim_' num2str(xDim)])
end
...
for nSession = 1:numSession
    ...
    setPrint(8*2, 6*2, ['Plots/TLDSLDASimilarityExampleSesssionHiShf_idx_' num2str(nSession, '%02d') '_xDim_' num2str(xDim)])
end
