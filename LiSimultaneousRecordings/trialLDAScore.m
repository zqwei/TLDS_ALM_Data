...
%         scoreMat(:, nTime) = squeeze(nSessionData(:, :, nTime)) * coeffs;
%     end
%     
...
% setPrint(8*mCol, 6*mRow, 'Plots/LDAscoreTrial')
...
setPrint(8*mCol, 6*mRow, 'Plots/SimilarityLDALDAscoreTrial')
...
setPrint(8*mCol, 6*mRow, 'Plots/SimilarityContraLDALDAscoreTrial')
...
setPrint(8*mCol, 6*mRow, 'Plots/SimilarityIpsiLDALDAscoreTrial')
