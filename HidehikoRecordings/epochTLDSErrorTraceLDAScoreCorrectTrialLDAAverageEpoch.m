...
for nSession =3 % 1:numSession
    ...
    figure;
    hold on
    shadedErrorBar(params.timeSeries, mean(simCorrMat(timePoint(2)-4:timePoint(2),:)),std(simCorrMat(timePoint(2)-4:timePoint(2),:))/sqrt(6),{'-','linewid',1, 'color', [0.4660    0.6740    0.1880]},0.5);
    ...
    setPrint(8, 6*1, ['Plots/TLDSLDASimilarityErrorSesssionCorrectLDAAve2_idx_' num2str(nSession, '%02d') '_xDim_' num2str(xDim)])
